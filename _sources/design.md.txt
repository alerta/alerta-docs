...
The following principles guided the design and development of
the Alerta monitoring system.

## Resource under alarm

A [resource](api/alert.rst#attributes) is any entity that it makes
...
for a telco you might want to use the six [ISO perceived severity levels](http://www.itu.int/rec/T-REC-X.733/en)
...
In accordance with the [robustness principle](http://en.wikipedia.org/wiki/Robustness_principle) which is to "be
...
however the benefits of following a standard [convention](/conventions)
